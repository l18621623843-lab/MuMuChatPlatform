...
<p align="center">
    <a style="margin-right: 5px">
       <img src="https://img.shields.io/badge/XueYi--MultiSaas-v3.6.1-brightgreen" alt="xueYi-MultiSaas">
    </a>
    <a style="margin-right: 5px">
...
## 注意
- 使用步骤创建数据库xy-config xy-cloud  xy-cloud1  将sql目录下的xy_config.sql导入到xy-config库将nacos设置数据库为xy-config
- 在naocs中设置好application-secret-dev.yml中的数据库连接，启动system模块，修改xy-cloud数据中的te_source的数据信息。
...
│        ├── xueyi-common-liquibase                   //数据库版本管理 - Liquibase
