package com.kk.mumuchat.system.api.authority.domain.po;
...
import com.kk.mumuchat.common.core.web.tenant.common.TCTreeEntity;
...
public class SysMenuPo extends TCTreeEntity<SysMenuDto> {
    ...
    /** 路由Meta配置 */
    @TableField(typeHandler = Fastjson2TypeHandler.class, updateStrategy = FieldStrategy.NOT_NULL)
    protected SysMenuMetaPo metaInfo;
