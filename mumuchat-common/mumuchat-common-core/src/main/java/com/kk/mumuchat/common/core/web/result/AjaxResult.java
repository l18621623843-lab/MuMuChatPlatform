...
public class AjaxResult extends HashMap<String, Object> {
     ...
     */
    public AjaxResult(int code, String type, String msg, String url, String originFileName) {
        super.put(CODE_TAG, code);
        super.put(TYPE_TAG, type);
        super.put(MSG_TAG, msg);
        ...
        if (StrUtil.isNotEmpty(originFileName)) {
            super.put(ORIGIN_FILE_NAME, originFileName);
        }
    }
     ...
     * @return 成功消息
     */
    public static AjaxResult success(String msg, String url, String originFileName) {
        return new AjaxResult(HttpConstants.Status.SUCCESS.getCode(), HttpConstants.ResultType.SUCCESS.getCode(), msg, url, originFileName);
    }
