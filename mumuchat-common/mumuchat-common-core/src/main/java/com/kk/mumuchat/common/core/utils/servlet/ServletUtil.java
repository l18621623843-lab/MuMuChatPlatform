package com.kk.mumuchat.common.core.utils.servlet;
...
public class ServletUtil {
     ...
     * 增加请求头
     */
    public static void addHeader(HttpHeaders headers, String name, Object value) {
        if (value == null)
            return;
     ...
     * 移除请求头
     */
    public static void removeHeader(HttpHeaders headers, String name) {
        headers.remove(name);
    }
