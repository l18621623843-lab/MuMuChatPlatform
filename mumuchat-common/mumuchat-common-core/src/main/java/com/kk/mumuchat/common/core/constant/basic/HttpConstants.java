...
public class HttpConstants {
    ...
    public enum HttpType {
        ...
        public static HttpType getByCode(String code) {
            return EnumUtil.getByCode(HttpType.class, code);
        }

        public static HttpType getByCodeElseNull(String code) {
            return EnumUtil.getByCodeElseNull(HttpType.class, code);
        }
    }
