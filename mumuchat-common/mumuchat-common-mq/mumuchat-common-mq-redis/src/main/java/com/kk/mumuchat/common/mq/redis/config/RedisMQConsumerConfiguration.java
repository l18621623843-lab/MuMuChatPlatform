...
import com.kk.mumuchat.common.mq.redis.core.job.RedisPendingMessageResendJob;
import com.kk.mumuchat.common.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import com.kk.mumuchat.common.mq.redis.core.stream.AbstractRedisStreamMessageListener;
 ...
 */
@Slf4j
// 启用定时任务，用于 RedisPendingMessageResendJob 重发消息
@EnableScheduling
