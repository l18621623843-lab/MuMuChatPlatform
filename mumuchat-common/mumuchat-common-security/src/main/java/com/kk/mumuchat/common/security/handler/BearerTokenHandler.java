...
public class BearerTokenHandler implements BearerTokenResolver {
    ...
    private boolean isParameterTokenSupportedForRequest(final HttpServletRequest request) {
        return ((StrUtil.equals(HttpConstants.HttpType.POST.getCode(), request.getMethod())
                && MediaType.APPLICATION_FORM_URLENCODED_VALUE.equals(request.getContentType()))
                || StrUtil.equals(HttpConstants.HttpType.GET.getCode(), request.getMethod()));
    }

    private boolean isParameterTokenEnabledForRequest(final HttpServletRequest request) {
        return ((this.allowFormEncodedBodyParameter && StrUtil.equals(HttpConstants.HttpType.POST.getCode(), request.getMethod())
                && MediaType.APPLICATION_FORM_URLENCODED_VALUE.equals(request.getContentType()))
                || (this.allowUriQueryParameter && StrUtil.equals(HttpConstants.HttpType.GET.getCode(), request.getMethod())));
    }
}