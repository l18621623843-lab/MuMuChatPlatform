...
public class RedisOAuth2AuthorizationHandler implements OAuth2AuthorizationService {
    ...
    public OAuth2Authorization findByToken(String token, @Nullable OAuth2TokenType tokenType) {
        ...
        return ObjectUtil.equals(OAuth2TokenType.ACCESS_TOKEN, tokenType) ? redisJavaService.getCacheObject(token) : ObjectUtil.equals(OAuth2TokenType.REFRESH_TOKEN, tokenType) ?  redisJavaService.getCacheObject(token) : null;
    }
