...
import com.kk.mumuchat.common.core.exception.file.FileException;
import com.kk.mumuchat.common.core.exception.file.FileNameLengthLimitExceededException;
import com.kk.mumuchat.common.core.exception.file.FileSizeLimitExceededException;
import com.kk.mumuchat.common.core.exception.file.InvalidExtensionException;
...
public class FileUploadUtils {
    ...
    public static String extractFilename(MultipartFile file) {
        return StrUtil.format("{}/{}_{}.{}", DateUtil.datePath(), FilenameUtils.getBaseName(file.getOriginalFilename()), IdUtil.getSnowflakeNextId(), FileTypeUtil.getExtension(file));
    }
