...
import com.kk.mumuchat.system.dict.domain.correlate.SysDictDataCorrelate;
...
public class SysDictDataServiceImpl extends BaseServiceImpl<SysDictDataQuery, SysDictDataDto, SysDictDataCorrelate, ISysDictDataManager> implements ISysDictDataService {
     ...
     */
    @Override
    public void refreshCache(OperateConstants.ServiceType operate, RedisConstants.OperateType cacheOperateType, SysDictDataDto dto, Collection<SysDictDataDto> dtoList,
