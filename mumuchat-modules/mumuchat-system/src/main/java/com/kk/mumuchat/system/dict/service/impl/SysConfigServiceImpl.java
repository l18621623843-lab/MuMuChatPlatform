...
import com.kk.mumuchat.system.dict.domain.correlate.SysConfigCorrelate;
import com.kk.mumuchat.system.dict.manager.ISysConfigManager;
import com.kk.mumuchat.system.dict.service.ISysConfigService;
...
public class SysConfigServiceImpl extends BaseServiceImpl<SysConfigQuery, SysConfigDto, SysConfigCorrelate, ISysConfigManager> implements ISysConfigService {
    ...
    public CacheModel getCacheModel() {
        return new CacheModel(ConfigConstants.CacheType.SYS_CONFIG_KEY);
    }
    ...
    public Boolean syncCache() {
        ...
        Map<String, SysConfigDto> enterpriseConfigMap = MapUtil.buildListToMap(enterpriseTypeList, SysConfigDto::getCode, Function.identity());
    ...
    public void clearCache() {
        Collection<String> keys = redisService.keys(ConfigConstants.CacheKey.CONFIG_KEY.getCacheName(StrUtil.ASTERISK));
     ...
     */
    @Override
    public void refreshCache(OperateConstants.ServiceType operate, RedisConstants.OperateType cacheOperateType, SysConfigDto dto, Collection<SysConfigDto> dtoList,
        ...
        // 默认缓存管理方法
        super.refreshCache(operate, cacheOperateType, dto, dtoList, cacheKey, isTenant, SysConfigDto::getCode, SysConfigDto::getValue);
        // 路由缓存管理方法
        if (SecurityUtils.isCommonTenant()) {
            ConfigConstants.CacheType routeCacheKey = ConfigConstants.CacheType.ROUTE_CONFIG_KEY;
            super.refreshCache(operate, cacheOperateType, dto, dtoList, routeCacheKey.getCode(), routeCacheKey.getIsTenant(), SysConfigDto::getCode, Function.identity());
        }
    }
}