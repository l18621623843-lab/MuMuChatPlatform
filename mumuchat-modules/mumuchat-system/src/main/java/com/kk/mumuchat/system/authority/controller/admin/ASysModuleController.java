...
import com.kk.mumuchat.system.authority.controller.base.BSysModuleController;
    ...
    public AjaxResult getRoutes() {
        ...
        if (ObjectUtil.isNull(moduleRoute)) {
            ...
            if (CollUtil.isNotEmpty(dataScope.getModuleIds())) {
                ...
                moduleRoute = moduleList.stream()
                        .filter(item -> ObjectUtil.equals(DictConstants.DicShowHide.SHOW.getCode(), item.getHideModule()))
