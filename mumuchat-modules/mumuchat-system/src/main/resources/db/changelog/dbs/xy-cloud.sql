...
create table te_tenant (
  ...
  secret_key                varchar(100)                                                comment '加密密钥',
  address                   varchar(200)                                                comment '定位地址',
  longitude                 double                                                      comment '经纬度坐标 - 经度',
  latitude                  double                                                      comment '经纬度坐标 - 纬度',
...
create table sys_menu (
  ...
  meta_info                 json                default null                            comment '路由Meta配置',
...
values (13000000, 0, '4be0456e05a7422d9f1c82fb7bf19377', '组织管理', 1, '0', 'organize', null, '', null, null, 'N', 'N', 'N', 'N', '0', 'M', '0', '0', '0', '0', '0', 1, null, '', 'ant-design:apartment-outlined', 1, '目录:组织管理', '0', 'Y', 1, 0),
       ...
       (16000000, 0, 'fa8965418a3540a99a62c805a4616e59', '系统管理', 1, '0', 'system', null, '', null, null, 'N', 'N', 'N', 'N', '0', 'M', '0', '0', '0', '0', '0', 1, null, '', 'ant-design:control-outlined', 4, '目录:系统管理', '0', 'Y', 1, 0),
           (16010000, 16000000, '60a02b15ddcf45eab582a0c57af6ae62', '定时任务', 2, '0,16000000', 'job', null, 'system/system/job/index', null, null, 'N', 'N', 'N', 'N', '0', 'C', '0', '0', '0', '0', '0', 1, null, 'FE:job:schedule:job:list, RD:job:schedule:job:list', 'ant-design:field-time-outlined', 1, '菜单:定时任务 | 调度任务管理 | 定时任务管理', '0', 'Y', 1, 0),
               (16010100, 16010000, '101aeea275ce4c61b0652491f75125c0', '任务详情', 3, '0,16000000,16010000', null, null, null, null, null, 'N', 'N', 'N', 'N', '0', 'F', '0', '0', '0', '0', '0', 1, null, 'FE:job:schedule:job:single, RD:job:schedule:job:single', null, 1, '详情:定时任务 | 调度任务管理 | 定时任务详情', '0', 'Y', 1, 0),
...
values (101001001, '默认|通用字典|性别', 'sys_user_sex', '默认|通用字典|性别列表', '0', '1', 0),
       (101001002, '默认|通用字典|显隐', 'sys_show_hide', '默认|通用字典|显隐列表', '0', '1', 0),
       (101001003, '默认|通用字典|公共私有', 'sys_common_private', '默认|通用字典|公共私有列表', '0', '1', 0),
       (101001004, '默认|通用字典|状态', 'sys_normal_disable', '默认|通用字典|状态列表', '0', '1', 0),
       (101001005, '默认|通用字典|功能状态', 'sys_function_status', '默认|通用字典|功能状态列表', '3', '1', 0),
       (101001006, '默认|通用字典|请求类型', 'sys_http_type', '默认|通用字典|请求类型列表', '3', '1', 0),
       (101001007, '默认|通用字典|是否', 'sys_yes_no', '默认|通用字典|是否列表', '0', '1', 0),
       (101001008, '默认|通用字典|消息状态', 'sys_message_status', '默认|通用字典|消息状态列表', '0', '1', 0),
       (102001001, '系统服务|消息模块|通知类型', 'sys_notice_type', '系统服务|消息模块|通知类型列表', '0', '1', 0),
       (102001002, '系统服务|消息模块|通知状态', 'sys_notice_status', '系统服务|消息模块|通知状态列表', '0', '1', 0),
       (102001003, '系统服务|监控模块|操作类型', 'sys_operate_business', '系统服务|监控模块|操作类型列表', '0', '1', 0),
       (102001004, '系统服务|监控模块|操作用户类别', 'sys_operate_type', '系统服务|监控模块|操作用户类别列表', '0', '1', 0),
       (102001005, '系统服务|监控模块|操作日志状态', 'sys_operate_status', '系统服务|监控模块|操作日志状态列表', '0', '1', 0),
       (102001006, '系统服务|字典模块|字典颜色', 'sys_dict_color', '系统服务|字典模块|字典颜色列表', '0', '1', 0),
       (102001007, '系统服务|权限模块|授权类型', 'sys_grant_type', '系统服务|权限模块|授权类型列表', '0', '1', 0),
       (102001008, '系统服务|权限模块|页面类型', 'auth_frame_type', '系统服务|权限模块|页面类型列表', '0', '1', 0),
       (102001009, '系统服务|权限模块|菜单类型', 'auth_menu_type', '系统服务|权限模块|菜单类型列表', '0', '1', 0),
       (102001010, '系统服务|权限模块|数据范围', 'auth_data_scope', '系统服务|权限模块|数据范围列表', '0', '1', 0),
       (102001011, '系统服务|字典模块|数据类型', 'sys_dict_data_type', '系统服务|字典模块|数据类型列表', '0', '1', 0),
       (102001012, '系统服务|字典模块|缓存类型', 'sys_dict_cache_type', '系统服务|字典模块|缓存类型列表', '0', '1', 0),
       (102001013, '系统服务|权限模块|菜单版本', 'auth_menu_version', '系统服务|权限模块|菜单版本列表', '0', '1', 0),
       (103001001, '租户服务|策略模块|源策略|策略类型', 'te_strategy_source_type', '租户服务|策略模块|源策略|策略类型列表（additional_a控制是否必填（Y必填/N非必填））', '3', '1', 0),
       (104001001, '定时任务|任务状态', 'sys_job_status', '定时任务|任务状态列表', '0', '1', 0),
       (104001002, '定时任务|任务策略', 'sys_job_policy', '定时任务|任务策略列表', '0', '1', 0),
       (104001003, '定时任务|任务并发', 'sys_job_concurrent', '定时任务|任务并发列表', '0', '1', 0),
       (104001004, '定时任务|任务分组', 'sys_job_group', '定时任务|任务分组列表', '0', '1', 0),
       (104001005, '定时任务|内部系统类型', 'sys_job_inner_type', '定时任务|内部系统类型列表', '0', '1', 0),
       (105001001, '代码生成|读写类型', 'sys_source_type', '代码生成|读写类型列表', '0', '1', 0),
       (105001002, '代码生成|数据源类型', 'sys_database_type', '代码生成|数据源类型列表', '0', '1', 0),
       (105001003, '代码生成|配置类型', 'te_configuration_type', '代码生成|配置类型列表', '0', '1', 0),
       (105001004, '代码生成|模板类型', 'gen_template_type', '代码生成|模板类型列表', '0', '1', 0),
       (105001005, '代码生成|属性类型', 'gen_java_type', '代码生成|属性类型列表', '0', '1', 0),
       (105001006, '代码生成|查询类型', 'gen_query_type', '代码生成|查询类型列表', '0', '1', 0),
       (105001007, '代码生成|显示类型', 'gen_display_type', '代码生成|显示类型列表', '0', '1', 0),
       (105001008, '代码生成|生成路径', 'gen_generation_mode', '代码生成|生成路径列表', '0', '1', 0),
       (105001009, '代码生成|源策略模式', 'gen_source_mode', '代码生成|源策略模式列表', '0', '1', 0);
...
values (101001001001, 1, '男', '0', 'sys_user_sex', '', '', 'Y', '默认|通用字典|性别：男', 0),
       (101001001002, 2, '女', '1', 'sys_user_sex', '', '', 'N', '默认|通用字典|性别：女', 0),
       (101001001003, 3, '未知', '2', 'sys_user_sex', '', '', 'N', '默认|通用字典|性别：未知', 0),
       (101001002001, 1, '显示', '0', 'sys_show_hide', '', 'blue', 'Y', '默认|通用字典|显隐：显示', 0),
       (101001002002, 2, '隐藏', '1', 'sys_show_hide', '', 'red', 'N', '默认|通用字典|显隐：隐藏', 0),
       (101001003001, 1, '公共', '0', 'sys_common_private', '', 'cyan', 'N', '默认|通用字典|公共私有：公共', 0),
       (101001003002, 2, '私有', '1', 'sys_common_private', '', 'purple', 'N', '默认|通用字典|公共私有：私有', 0),
       (101001004001, 1, '正常', '0', 'sys_normal_disable', '', 'blue', 'Y', '默认|通用字典|状态：正常', 0),
       (101001004002, 2, '停用', '1', 'sys_normal_disable', '', 'red', 'N', '默认|通用字典|状态：停用', 0),
       (101001005001, 1, '开启', 'Y', 'sys_function_status', '', 'blue', 'N', '默认|通用字典|功能状态: 开启', 0),
       (101001005002, 2, '关闭', 'N', 'sys_function_status', '', 'orange', 'Y', '默认|通用字典|功能状态: 关闭', 0),
       (101001006001, 1, 'GET', 'GET', 'sys_http_type', '', 'blue', 'Y', '默认|通用字典|请求类型：GET', 0),
       ...
       (101001007001, 1, '是', 'Y', 'sys_yes_no', '', 'blue', 'Y', '默认|通用字典|是否：是', 0),
       (101001007002, 2, '否', 'N', 'sys_yes_no', '', 'red', 'N', '默认|通用字典|是否：否', 0),
       (101001008001, 1, '成功', '0', 'sys_message_status', '', 'blue', 'N', '默认|通用字典|消息状态：成功', 0),
       (101001008002, 2, '失败', '1', 'sys_message_status', '', 'red', 'N', '默认|通用字典|消息状态：失败', 0),
       (102001001001, 1, '通知', '0', 'sys_notice_type', '', 'blue', 'Y', '系统服务|消息模块|通知类型：通知', 0),
       (102001001002, 2, '公告', '1', 'sys_notice_type', '', 'green', 'N', '系统服务|消息模块|通知类型：公告', 0),
       (102001002001, 1, '待发送', '0', 'sys_notice_status', '', 'blue', 'Y', '系统服务|消息模块|通知状态：待发送', 0),
       (102001002002, 2, '已发送', '1', 'sys_notice_status', '', 'green', 'N', '系统服务|消息模块|通知状态：已发送', 0),
       (102001002003, 3, '已关闭', '2', 'sys_notice_status', '', 'cyan', 'N', '系统服务|消息模块|通知状态：已关闭', 0),
       (102001002004, 4, '发送失败', '3', 'sys_notice_status', '', 'orange', 'N', '系统服务|消息模块|通知状态：发送失败', 0),
       (102001002005, 5, '发送异常', '4', 'sys_notice_status', '', 'red', 'N', '系统服务|消息模块|通知状态：发送异常', 0),
       (102001003001, 1, '其它', '00', 'sys_operate_business', '', 'orange', 'N', '系统服务|监控模块|操作类型：其它', 0),
       (102001003002, 2, '新增', '01', 'sys_operate_business', '', 'blue', 'N', '系统服务|监控模块|操作类型：新增', 0),
       (102001003003, 3, '强制新增', '02', 'sys_operate_business', '', 'red', 'N', '系统服务|监控模块|操作类型：强制新增', 0),
       (102001003004, 4, '修改', '03', 'sys_operate_business', '', 'green', 'N', '系统服务|监控模块|操作类型：修改', 0),
       (102001003005, 5, '强制修改', '04', 'sys_operate_business', '', 'red', 'N', '系统服务|监控模块|操作类型：强制修改', 0),
       (102001003006, 6, '权限控制', '05', 'sys_operate_business', '', 'purple', 'N', '系统服务|监控模块|操作类型：权限控制', 0),
       (102001003007, 7, '修改状态', '06', 'sys_operate_business', '', 'purple', 'N', '系统服务|监控模块|操作类型：修改状态', 0),
       (102001003008, 8, '强制修改状态', '07', 'sys_operate_business', '', 'red', 'N', '系统服务|监控模块|操作类型：强制修改状态', 0),
       (102001003009, 9, '删除', '08', 'sys_operate_business', '', 'orange', 'N', '系统服务|监控模块|操作类型：删除', 0),
       (102001003010, 10, '强制删除', '09', 'sys_operate_business', '', 'red', 'N', '系统服务|监控模块|操作类型：强制删除', 0),
       (102001003011, 11, '授权', '10', 'sys_operate_business', '', 'orange', 'N', '系统服务|监控模块|操作类型：授权', 0),
       (102001003012, 12, '导出', '11', 'sys_operate_business', '', 'pink', 'N', '系统服务|监控模块|操作类型：导出', 0),
       (102001003013, 13, '导入', '12', 'sys_operate_business', '', 'cyan', 'N', '系统服务|监控模块|操作类型：导入', 0),
       (102001003014, 14, '强退', '13', 'sys_operate_business', '', 'orange', 'N', '系统服务|监控模块|操作类型：强退', 0),
       (102001003015, 15, '生成代码', '14', 'sys_operate_business', '', 'orange', 'N', '系统服务|监控模块|操作类型：生成代码', 0),
       (102001003016, 16, '清空数据', '15', 'sys_operate_business', '', 'orange', 'N', '系统服务|监控模块|操作类型：清空数据', 0),
       (102001003017, 17, '更新缓存', '16', 'sys_operate_business', '', 'orange', 'N', '系统服务|监控模块|操作类型：更新缓存', 0),
       (102001004001, 1, '其它', '00', 'sys_operate_type', '', 'green', 'N', '系统服务|监控模块|操作用户类别：其它', 0),
       (102001004002, 2, '后台用户', '01', 'sys_operate_type', '', 'blue', 'N', '系统服务|监控模块|操作用户类别：后台用户', 0),
       (102001004003, 3, '手机端用户', '02', 'sys_operate_type', '', 'red', 'N', '系统服务|监控模块|操作用户类别：手机端用户', 0),
       (102001005001, 1, '正常', '0', 'sys_operate_status', '', 'green', 'N', '系统服务|监控模块|操作日志状态：正常', 0),
       (102001005002, 2, '异常', '1', 'sys_operate_status', '', 'red', 'N', '系统服务|监控模块|操作日志状态：异常', 0),
       (102001006001, 1, 'none', '', 'sys_dict_color', '', '', 'N', '系统服务|字典模块|字典颜色：none', 0),
       (102001006002, 2, 'red', 'red', 'sys_dict_color', '', 'red', 'N', '系统服务|字典模块|字典颜色：red', 0),
       (102001006003, 3, 'pink', 'pink', 'sys_dict_color', '', 'pink', 'N', '系统服务|字典模块|字典颜色：pink', 0),
       (102001006004, 4, 'orange', 'orange', 'sys_dict_color', '', 'orange', 'N', '系统服务|字典模块|字典颜色：orange', 0),
       (102001006005, 5, 'green', 'green', 'sys_dict_color', '', 'green', 'N', '系统服务|字典模块|字典颜色：green', 0),
       (102001006006, 6, 'blue', 'blue', 'sys_dict_color', '', 'blue', 'N', '系统服务|字典模块|字典颜色：blue', 0),
       (102001006007, 7, 'purple', 'purple', 'sys_dict_color', '', 'purple', 'N', '系统服务|字典模块|字典颜色：purple', 0),
       (102001006008, 8, 'cyan', 'cyan', 'sys_dict_color', '', 'cyan', 'N', '系统服务|字典模块|字典颜色：cyan', 0),
       (102001007001, 1, '授权码模式', 'authorization_code', 'sys_grant_type', '', '', 'N', '系统服务|权限模块|授权类型：授权码模式', 0),
       (102001007002, 2, '密码模式', 'password', 'sys_grant_type', '', '', 'N', '系统服务|权限模块|授权类型：密码模式', 0),
       (102001007003, 3, '客户端模式', 'client_credentials', 'sys_grant_type', '', '', 'N', '系统服务|权限模块|授权类型：客户端模式', 0),
       (102001007004, 4, '简化模式', 'implicit', 'sys_grant_type', '', '', 'N', '系统服务|权限模块|授权类型：简化模式', 0),
       (102001007005, 5, '刷新模式', 'refresh_token', 'sys_grant_type', '', '', 'N', '系统服务|权限模块|授权类型：刷新模式', 0),
       (102001008001, 1, '常规', '0', 'auth_frame_type', '', 'pink', 'Y', '系统服务|权限模块|页面类型：常规', 0),
       (102001008002, 2, '内嵌', '1', 'auth_frame_type', '', 'cyan', 'N', '系统服务|权限模块|页面类型：内嵌', 0),
       (102001008003, 3, '外链', '2', 'auth_frame_type', '', 'green', 'N', '系统服务|权限模块|页面类型：外链', 0),
       (102001009001, 1, '目录', 'M', 'auth_menu_type', '', 'pink', 'Y', '系统服务|权限模块|菜单类型：目录', 0),
       (102001009002, 2, '菜单', 'C', 'auth_menu_type', '', 'cyan', 'N', '系统服务|权限模块|菜单类型：菜单', 0),
       (102001009003, 3, '详情', 'X', 'auth_menu_type', '', 'purple', 'N', '系统服务|权限模块|菜单类型：详情', 0),
       (102001009004, 4, '按钮', 'F', 'auth_menu_type', '', 'green', 'N', '系统服务|权限模块|菜单类型：按钮', 0),
       (102001010001, 1, '全部数据权限', '1', 'auth_data_scope', '', '', 'Y', '系统服务|权限模块|数据范围：全部数据权限', 0),
       (102001010002, 2, '自定数据权限', '2', 'auth_data_scope', '', '', 'N', '系统服务|权限模块|数据范围：自定数据权限', 0),
       (102001010003, 3, '本部门数据权限', '3', 'auth_data_scope', '', '', 'N', '系统服务|权限模块|数据范围：本部门数据权限', 0),
       (102001010004, 4, '本部门及以下数据权限', '4', 'auth_data_scope', '', '', 'N', '系统服务|权限模块|数据范围：本部门及以下数据权限', 0),
       (102001010005, 5, '本岗位数据权限', '5', 'auth_data_scope', '', '', 'N', '系统服务|权限模块|数据范围：本岗位数据权限', 0),
       (102001010006, 6, '仅本人数据权限', '6', 'auth_data_scope', '', '', 'N', '系统服务|权限模块|数据范围：仅本人数据权限', 0),
       (102001011001, 1, '默认', '0', 'sys_dict_data_type', '', 'blue', 'N', '系统服务|字典模块|数据类型：默认', 0),
       (102001011002, 2, '只增', '1', 'sys_dict_data_type', '', 'green', 'N', '系统服务|字典模块|数据类型：只增', 0),
       (102001011003, 3, '只减', '2', 'sys_dict_data_type', '', 'cyan', 'N', '系统服务|字典模块|数据类型：只减', 0),
       (102001011004, 4, '只读', '3', 'sys_dict_data_type', '', 'purple', 'N', '系统服务|字典模块|数据类型：只读', 0),
       (102001012001, 1, '租户', '0', 'sys_dict_cache_type', '', 'purple', 'N', '系统服务|字典模块|缓存类型：租户', 0),
       (102001012002, 2, '全局', '1', 'sys_dict_cache_type', '', 'blue', 'N', '系统服务|字典模块|缓存类型：全局', 0),
       (102001013001, 1, 'V2', 'v2', 'auth_menu_version', '', 'blue', 'N', '系统服务|权限模块|菜单版本：V2', 0),
       (102001013002, 2, 'V5', 'v5', 'auth_menu_version', '', 'purple', 'N', '系统服务|权限模块|菜单版本：V5', 0),
       (104001001001, 1, '正常', '0', 'sys_job_status', '', 'blue', 'Y', '定时任务|任务状态：正常', 0),
       (104001001002, 2, '暂停', '1', 'sys_job_status', '', 'red', 'N', '定时任务|任务状态：停用', 0),
       (104001002001, 1, '默认', '0', 'sys_job_policy', '', 'blue', 'N', '定时任务|任务策略：默认', 0),
       (104001002002, 2, '立即执行', '1', 'sys_job_policy', '', 'green', 'N', '定时任务|任务策略：立即执行', 0),
       (104001002003, 3, '执行一次', '2', 'sys_job_policy', '', 'cyan', 'N', '定时任务|任务策略：执行一次', 0),
       (104001002004, 4, '放弃执行', '3', 'sys_job_policy', '', 'purple', 'N', '定时任务|任务策略：放弃执行', 0),
       (104001003001, 1, '允许', '0', 'sys_job_concurrent', '', 'blue', 'N', '定时任务|任务并发：允许', 0),
       (104001003002, 2, '禁止', '1', 'sys_job_concurrent', '', 'red', 'N', '定时任务|任务并发：禁止', 0),
       (104001004001, 1, '默认', 'DEFAULT', 'sys_job_group', '', '', 'Y', '定时任务|任务分组：默认', 0),
       ...
       (105001001001, 1, '读&写', '0', 'sys_source_type', '', 'blue', 'Y', '代码生成|读写类型：读&写', 0),
       (105001001002, 2, '只读', '1', 'sys_source_type', '', 'green', 'N', '代码生成|读写类型：只读', 0),
       (105001001003, 3, '只写', '2', 'sys_source_type', '', 'red', 'N', '代码生成|读写类型：只写', 0),
       (105001002001, 1, '子数据源', '0', 'sys_database_type', '', 'green', 'Y', '代码生成|数据源类型：子数据源', 0),
       (105001002002, 2, '主数据源', '1', 'sys_database_type', '', 'red', 'N', '代码生成|数据源类型：主数据源', 0),
       (105001003001, 1, '自动配置', '0', 'te_configuration_type', '', '', 'N', '代码生成|配置类型：自动配置', 0),
       (105001003002, 2, '手动配置', '1', 'te_configuration_type', '', '', 'N', '代码生成|配置类型：手动配置', 0),
       (105001004001, 1, '单表', 'base', 'gen_template_type', '', '', 'Y', '代码生成|模板类型：单表', 0),
       (105001004002, 2, '树表', 'tree', 'gen_template_type', '', '', 'N', '代码生成|模板类型：树表', 0),
       (105001004003, 3, '关联表', 'merge', 'gen_template_type', '', '', 'N', '代码生成|模板类型：关联表', 0),
       (105001005001, 1, 'Long', 'Long', 'gen_java_type', '', '', 'N', '代码生成|属性类型：Long', 0),
       (105001005002, 2, 'String', 'String', 'gen_java_type', '', '', 'N', '代码生成|属性类型：String', 0),
       (105001005003, 3, 'Integer', 'Integer', 'gen_java_type', '', '', 'N', '代码生成|属性类型：Integer', 0),
       (105001005004, 4, 'Double', 'Double', 'gen_java_type', '', '', 'N', '代码生成|属性类型：Double', 0),
       (105001005005, 5, 'BigDecimal', 'BigDecimal', 'gen_java_type', '', '', 'N', '代码生成|属性类型：BigDecimal', 0),
       (105001005006, 6, 'LocalDateTime', 'LocalDateTime', 'gen_java_type', '', '', 'N', '代码生成|属性类型：LocalDateTime', 0),
       (105001006001, 1, '=', 'eq', 'gen_query_type', '', '', 'Y', '代码生成|查询类型：=', 0),
       (105001006002, 2, '!=', 'ne', 'gen_query_type', '', '', 'N', '代码生成|查询类型：!=', 0),
       (105001006003, 3, '>', 'gt', 'gen_query_type', '', '', 'N', '代码生成|查询类型：>', 0),
       (105001006004, 4, '>=', 'ge', 'gen_query_type', '', '', 'N', '代码生成|查询类型：>=', 0),
       (105001006005, 5, '<', 'lt', 'gen_query_type', '', '', 'N', '代码生成|查询类型：<', 0),
       (105001006006, 6, '<=', 'le', 'gen_query_type', '', '', 'N', '代码生成|查询类型：<=', 0),
       (105001006007, 7, 'LIKE', 'like', 'gen_query_type', '', '', 'N', '代码生成|查询类型：LIKE', 0),
       (105001006008, 8, 'NOT_LIKE', 'notLike', 'gen_query_type', '', '', 'N', '代码生成|查询类型：NOT_LIKE', 0),
       (105001006009, 9, 'LIKE_LEFT', 'likeLeft', 'gen_query_type', '', '', 'N', '代码生成|查询类型：LIKE_LEFT', 0),
       (105001006010, 10, 'LIKE_RIGHT', 'likeRight', 'gen_query_type', '', '', 'N', '代码生成|查询类型：LIKE_RIGHT', 0),
       (105001006011, 11, 'BETWEEN', 'between', 'gen_query_type', '', '', 'N', '代码生成|查询类型：BETWEEN', 0),
       (105001006012, 12, 'NOT_BETWEEN', 'notBetween', 'gen_query_type', '', '', 'N', '代码生成|查询类型：NOT_BETWEEN', 0),
       (105001006013, 13, 'ISNULL', 'isNull', 'gen_query_type', '', '', 'N', '代码生成|查询类型：ISNULL', 0),
       (105001006014, 14, 'IS_NOT_NULL', 'isNotNull', 'gen_query_type', '', '', 'N', '代码生成|查询类型：IS_NOT_NULL', 0),
       (105001007001, 1, '文本框', 'Input', 'gen_display_type', '', '', 'Y', '代码生成|显示类型：文本框', 0),
       (105001007002, 2, '密码框', 'InputPassword', 'gen_display_type', '', '', 'Y', '代码生成|显示类型：密码框', 0),
       (105001007003, 3, '数字输入框', 'InputNumber', 'gen_display_type', '', '', 'Y', '代码生成|显示类型：数字输入框', 0),
       (105001007004, 4, '文本域', 'InputTextArea', 'gen_display_type', '', '', 'N', '代码生成|显示类型：文本域', 0),
       (105001007005, 5, '下拉框', 'Select', 'gen_display_type', '', '', 'N', '代码生成|显示类型：下拉框', 0),
       (105001007006, 6, '单选框', 'CheckboxGroup', 'gen_display_type', '', '', 'N', '代码生成|显示类型：单选框', 0),
       (105001007007, 7, '按钮风格单选框', 'RadioButtonGroup', 'gen_display_type', '', '', 'N', '代码生成|显示类型：按钮风格单选框', 0),
       (105001007008, 8, '复选框', 'RadioGroup', 'gen_display_type', '', '', 'N', '代码生成|显示类型：复选框', 0),
       (105001007009, 9, '日期控件', 'DatePicker', 'gen_display_type', '', '', 'N', '代码生成|显示类型：日期控件', 0),
       (105001007010, 10, '时间控件', 'TimePicker', 'gen_display_type', '', '', 'N', '代码生成|显示类型：时间控件', 0),
       (105001007011, 11, '图片上传', 'ImageUpload', 'gen_display_type', '', '', 'N', '代码生成|显示类型：图片上传', 0),
       (105001007012, 12, '文件上传', 'Upload', 'gen_display_type', '', '', 'N', '代码生成|显示类型：文件上传', 0),
       (105001007013, 13, '富文本控件', 'tinymce', 'gen_display_type', '', '', 'N', '代码生成|显示类型：富文本控件', 0),
       (105001007014, 14, 'MarkDown编辑器控件', 'markdown', 'gen_display_type', '', '', 'N', '代码生成|显示类型：MarkDown编辑器控件', 0),
       (105001008001, 1, '默认路径', '0', 'gen_generation_mode', '', '', 'Y', '代码生成|生成路径：默认路径', 0),
       (105001008002, 2, '自定义路径', '1', 'gen_generation_mode', '', '', 'N', '代码生成|生成路径：自定义路径', 0),
       (105001009001, 1, '策略源', 'Isolate', 'gen_source_mode', '', '', 'Y', '代码生成|源策略模式：策略源', 0),
       (105001009002, 2, '主数据源', 'Master', 'gen_source_mode', '', '', 'N', '代码生成|源策略模式：主数据源', 0);


insert into sys_dict_data (id, sort, label, value, code, additional_a, additional_b, additional_c, css_class, list_class, is_default, remark, tenant_id)
     values (103001001001, 1, '业务源A', 'sourceType1', 'te_strategy_source_type', 'N', null, null, '', 'blue', 'N', '租户服务|策略模块|源策略|策略类型：业务源A（非必填）', 0);
...
create table sys_job (
  ...
  server_type               varchar(12)                                                 comment '归属服务',
  http_type                 varchar(12)                                                 comment '请求类型',
  api_url                   varchar(500)                                                comment '请求地址',
...
insert into sys_job (id, name, job_group, server_type, http_type, api_url, invoke_target, invoke_tenant, cron_expression, misfire_policy, concurrent, status, tenant_id)
values (1, '系统默认（无参）', 'DEFAULT', null, null, null, 'ryTask.ryNoParams',   '1',     '0/10 * * * * ?', '3', '1', '1', 1),
       (2, '系统默认（有参）', 'DEFAULT', null, null, null, 'ryTask.ryParams(\'ry\')',   '1',  '0/15 * * * * ?', '3', '1', '1', 1),
       (3, '系统默认（多参）', 'DEFAULT', null, null, null, 'ryTask.ryMultipleParams(\'ry\', true, 2000L, 316.50D, 100)',   '1',  '0/20 * * * * ?', '3', '1', '1', 1),
       (4, '内部服务接口测试任务', 'INNER_SYSTEM', 'xueyi-system', 'GET', '/inner/dict/type/common/refresh', null, '1', '0/20 * * * * ?', '3', '1', '1', 1);
...
values (1, 'app',       null, 'app', 'server', 'app,refresh_token', null, null, null, null, null, 'true', 1, '0'),
       ...
       (4, 'xueyi',     null, 'xueyi', 'server', 'password,app,wechat_ma,wechat_mp,refresh_token,authorization_code,client_credentials,MP-WEIXIN,MP-TOUTIAO,H5_EMBED,MP-ALIPAY', 'https://xueyitt.cn', null, null, null, null, 'true', 1, '0'),
